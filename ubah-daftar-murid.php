...
$murid = query("SELECT * FROM murid WHERE IDMURID = '$murid'")[0];
...
if ( isset($_POST["submit"]) ) {
  ...
  if (ubahJadwalPelajaran($_POST) > 0) {
    ...
    $message = 'Data murid telah berhasil diubah ke dalam database';
    echo "<script>
...
>
  <head>
    ...
    <title>Ubah Murid | Kelompok 2</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="http://localhost:8080/jadwal-pelajaran/daftar-murid.php" class="menu-link">
                    <div data-i18n="Daftar Murid">Daftar</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="http://localhost:8080/jadwal-pelajaran/tambah-murid.php" class="menu-link">
              ...
              <div class="col-xxl">
                <div class="card mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Form Ubah Murid</h5>
                  </div>
                  <div class="card-body">
                  ...
                  <label class="col-sm-2 col-form-label" for="no-induk">NO INDUK</label>
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="id-telegram">ID TELEGRAM</label>
                        <div class="col-sm-10">
                          <input class="form-control" id="id-telegram" name="id_telegram" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="id-line">ID LINE</label>
                        <div class="col-sm-10">
                          <input class="form-control" id="id-line" name="id_line" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="id-facebook">ID FACEBOOK</label>
                        <div class="col-sm-10">
                          <input class="form-control" id="id-facebook" name="id-facebook" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="id-instagram">ID INSTAGRAM</label>
                        <div class="col-sm-10">
                          <input class="form-control" id="id-instagram" name="id-instagram" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="id-twitter">ID TWITTER</label>
                        <div class="col-sm-10">
                          <input class="form-control" id="id-twitter" name="id-twitter" required />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="id-youtube">ID YOUTUBE</label>
                        <div class="col-sm-10">
                          <input class="form-control" id="id-youtube" name="id-youtube" required />
                        </div>
                      </div>
